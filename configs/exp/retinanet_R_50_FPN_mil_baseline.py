...
from exp.retinanet_mil_cls_branch import RetinaNetM, ImageClsHead
...
dataloader.train = L(build_detection_train_loader)(
    dataset=L(get_detection_dataset_dicts)(names="abp_shishi_c4_train", filter_empty=False),
...
dataloader.test = L(build_detection_test_loader)(
    dataset=L(get_detection_dataset_dicts)(names="abp_shishi_c4_test", filter_empty=False),
    mapper=L(DatasetMapper)(
        is_train=False,
        augmentations=[
...
########## train ############
train = dict(
    output_dir="./output/mil_baseline_new_topk_sampler",
    # init_checkpoint="/nasdata/share/abp_trainer/trained_models/retinanet_mil_211103/model_0119999.pth",
    init_checkpoint="/nasdata/private/zwlu/Now/ai_trainer/output/mil_baseline_new_topk_sampler/model_0000999.pth",
    # pretrained model from jli
    ...
    checkpointer=dict(period=200, max_to_keep=20),  # options for PeriodicCheckpointer
    eval_period=200,
    log_period=20,
    device="cuda"
    # ...
