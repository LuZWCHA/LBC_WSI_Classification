...
def main(args):
    ...
    if args.eval_only:
        ...
        # flops, params = profile(model, inputs=[[{"image": torch.zeros(3, 1280, 1280, dtype=torch.float16)}],])
        ...
        #     input_data=[[{"image": torch.zeros(3, 1280, 1280, device=cfg.train.device)}],], 
        #     device=cfg.train.device, 
        #     save_graph=True, 
        #     filename="retina_res50_fpn", 
